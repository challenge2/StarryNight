...
namespace StarryNight.ViewModel
{
    ...
    class BeeStarViewModel
    {
        ...
        void BeeMovedHandler(object sender, BeeMovedEventArgs e)
        {
            ...
            {
                AnimatedImage beeControl = BeeStarHelper.BeeFactory(e.BeeThatMoved.Width,
                                            e.BeeThatMoved.Height, TimeSpan.FromMilliseconds(20));  //* AnimatedImage
        ...
        void StarChangedHandler(object sender, StarChangedEventArgs e)
        {
            ...
            else
            {
                ...
                BeeStarHelper.SetCanvasLocation(newStar, e.StarThatChanged.Location.X,
